...
def parse_args():
    ...
    parser.add_argument('--val-every', type=int, default=4, help='Validate every n epochs during training')
    ...
    parser.add_argument('--num-viz-images', type=int, default=10, help='Number of visualisation images to save at validation (value is ceiled to batch size)')
